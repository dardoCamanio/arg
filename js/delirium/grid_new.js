...
$(function() {
        ...
        $[fn][elastic_grid] = function(_0xabcbx13) {
            ...
            _0xabcbx14[html]( < div class = "wagwep-container" > < nav id = "porfolio-nav"
                class = "clearfix" > < ul id = "portfolio-filter"
                class = "nav nav-tabs clearfix" > < /ul></nav > < /div>);var _0xabcbxd=;var _0xabcbx16=$(<ul id="og-grid" class="og-grid"></ul > );
            for(itemIdx = 0; itemIdx < _0xabcbx15; itemIdx++) {
                if(_0xabcbx13[items][itemIdx] != undefined) {
                    var _0xabcbx17 = _0xabcbx13[items][itemIdx];
                    liObject = $( < li > < /li>);tags=_0xabcbx17[tags];strTag=;for(var _0xabcbx18=tags[length]-1;_0xabcbx18>=0;_0xabcbx18--){strTag+=,+tags[_0xabcbx18];} ;strTag=strTag[substring](1);liObject[attr](data-tags,strTag);aObject=$(<a></a > );
                    aObject[attr](href, javascript: ;;);
                    imgObject = $( < img / > );
                    imgObject[attr](src, _0xabcbx17[thumbnail][0]);
                    imgObject[attr](data - largesrc, _0xabcbx17[large][0]);
                    spanObject = $( < span > < /span>);spanObject[html](_0xabcbx17[title]);figureObject=$(<figure></figure > );
            ...
            _0xabcbx4[prototype] = {
                create: function() {
                    ...
                    this[$href] = $( < a href = "#" > Visit website < /a>);this[$detailButtonList]=$(<span class="buttons-list"></span > );
                    this[$details] = $( < div class = "og-details" > < /div>)[append](this.$title,this.$description,this.$detailButtonList);this[$loading]=$(<div class="og-loading"></div > );
                    this[$fullimage] = $( < div class = "og-fullimg" > < /div>)[append](this.$loading);this[$closePreview]=$(<span class="og-close"></span > );
                    this[$previewInner] = $( < div class = "og-expander-inner" > < /div>)[append](this.$closePreview,this.$fullimage,this.$details);this[$previewEl]=$(<div class="og-expander"></div > )[append](this.$previewInner);
                    this[$item][append]($( < div class = "og-pointer" > < /div>));this[$item][append](this[getEl]());if(_0xabcbx26){this[setTransition]();} ;} ,update:function (_0xabcbx1a){if(_0xabcbx1a){this[$item]=_0xabcbx1a;} ;if(_0xabcbx1f!==-1){var _0xabcbx2b=_0xabcbxa[eq](_0xabcbx1f);_0xabcbx2b[removeClass](og-expanded);this[$item][addClass](og-expanded);this[positionPreview]();} ;_0xabcbx1f=this[$item][index]();if( typeof _0xabcbx13[items][_0xabcbx1f]===undefined){} else {eldata=_0xabcbx13[items][_0xabcbx1f];this[$title][html](eldata[title]);this[$description][html](eldata[description]);this[$detailButtonList][html]();urlList=eldata[button_list];if(urlList[length]>0){for(_0xabcbx18=0;_0xabcbx18<urlList[length];_0xabcbx18++){var _0xabcbxc=$(<a></a > ); _0xabcbxc[addClass](link - button);
                        if(_0xabcbx18 == 0) {
                            _0xabcbxc[addClass](first);
                        }; _0xabcbxc[attr](href, urlList[_0xabcbx18][url]); _0xabcbxc[html](urlList[_0xabcbx18][title]); this[$detailButtonList][append](_0xabcbxc);
                    };
                };
                var _0xabcbx1c = this;
                if(typeof _0xabcbx1c[$largeImg] != undefined) {
                    _0xabcbx1c[$largeImg][remove]();
                };glarge = eldata[large];gthumbs = eldata[thumbnail];
                if(glarge[length] == gthumbs[length] && glarge[length] > 0) {
                    var _0xabcbx1d = $( < ul > < /ul>);for(_0xabcbx18=0;_0xabcbx18<gthumbs[length];_0xabcbx18++){var _0xabcbx2c=$(<li></li > );
                    var _0xabcbxc = $( < a href = "javascript:;;" > < /a>);var _0xabcbx1b=$(<img/ > );
                ...
                };_0xabcbx1d[addClass](elastislide - list);_0xabcbx1d[elastislide]();
                var _0xabcbx2d = $( < div class = "elastislide-wrapper elastislide-horizontal" > < /div>);_0xabcbx2d[append](_0xabcbx1d)[find](.related_photo)[bind](click,function (){_0xabcbx2d[find](.selected)[removeClass](selected);$(this)[addClass](selected);$largePhoto=$(this)[data](large);$(<img/ > )[load](function() {
                    _0xabcbx1c[$fullimage][find](img)[fadeOut](500, function() {
                        $(this)[fadeIn](500)[attr](src, $largePhoto);
                    });
                })[attr](src, $largePhoto);
            });
        _0xabcbx1c[$details][append]( < div class = "infosep" > < /div>);_0xabcbx1c[$details][append](_0xabcbx2d);} else {_0xabcbx1c[$details][find](.infosep, .og-grid-small)[remove]();} ;if(_0xabcbx1c[$fullimage][is](:visible)){this[$loading][show]();$(<img/ > )[load](function() {
            var _0xabcbx2e = $(this);
...
(function(_0xabcbxd, _0xabcbxa, _0xabcbx4) {
        ...
        _0xabcbxd[Elastislide][prototype] = {
            _init: function(_0xabcbxf) {
                ...
                this[$el][wrap]( < div class = "elastislide-wrapper elastislide-loading elastislide-+this[options][orientation]+" > < /div>);this[hasTransition]=false;this[hasTransitionTimeout]=setTimeout(function (){_0xabcbxe._addTransition();} ,100);this[$el][imagesLoaded](function (){_0xabcbxe[$el][show]();_0xabcbxe._layout();_0xabcbxe._configure();if(_0xabcbxe[hasTransition]){_0xabcbxe._removeTransition();_0xabcbxe._slideToItem(_0xabcbxe[current]);_0xabcbxe[$el][on](_0xabcbxe[transEndEventName],function (){_0xabcbxe[$el][off](_0xabcbxe[transEndEventName]);_0xabcbxe._setWrapperSize();_0xabcbxe._addTransition();_0xabcbxe._initEvents();} );} else {clearTimeout(_0xabcbxe[hasTransitionTimeout]);_0xabcbxe._setWrapperSize();_0xabcbxe._initEvents();_0xabcbxe._slideToItem(_0xabcbxe[current]);setTimeout(function (){_0xabcbxe._addTransition();} ,25);} ;_0xabcbxe[options][onReady]();} );} ,_validate:function (){if(this[options][speed]<0){this[options][speed]=500;} ;if(this[options][minItems]<1||this[options][minItems]>this[itemsCount]){this[options][minItems]=1;} ;if(this[options][start]<0||this[options][start]>this[itemsCount]-1){this[options][start]=0;} ;if(this[options][orientation]!=horizontal&&this[options][orientation]!=vertical){this[options][orientation]=horizontal;} ;} ,_layout:function (){this[$el][wrap](<div class="elastislide-carousel"></div > );
            ...
            _addControls: function() {
                var _0xabcbxe = this;
                this[$navigation] = _0xabcbxd( < nav > < span class = "elastislide-prev" > Previous < /span><span class="elastislide-next">Next</span > < /nav>)[appendTo](this.$wrapper);this[$navPrev]=this[$navigation][find](span.elastislide-prev)[on](mousedown.elastislide,function (_0xabcbxf){_0xabcbxe._slide(prev);return false;} );this[$navNext]=this[$navigation][find](span.elastislide-next)[on](mousedown.elastislide,function (_0xabcbxf){_0xabcbxe._slide(next);return false;} );} ,_setItemsSize:function (){var _0xabcbxe=this[options][orientation]===horizontal?(Math[floor](this[$carousel][width]()/this [options][minItems]) * 100) / this[$carousel][width](): 100;this[$items][css]({
                width: _0xabcbxe + % ,

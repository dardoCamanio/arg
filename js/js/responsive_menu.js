...
mst(document).ready(function($) {
	...
	//------------------Active State--------------------
	MCP = {
		addActiveClass : function(selector, activeClass) {
			...
			/****NOTICE: If you just want active class visiable in li level 0, and remove in all another level then uncomment below code */
